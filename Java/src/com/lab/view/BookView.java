...
public class BookView {
    ...
    public static final String MENU_POSSIBILITIES =
            "\n1 - Show all books\n" +
                    ...
                    "6 - Exit\n";
    public static final String WRONG_NEGATIVE_DATA = "Wrong input! This number cannot be less than zero. Repeat please.";
    public static final String TOO_BIG_YEAR_DATA = "Wrong input! This year has not come yet. Repeat please.";
    //...//
